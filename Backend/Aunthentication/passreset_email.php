...
// Generating Unique Password Resetting Link
$resetLink = "http://127.0.0.1/Scraper/Frontend/HTML/pass_reset.html?email={$email}&token={$token}";
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Please use theese one time password reset link</p>
            
            <div class="otp-display">
               <p>Password Reset Link: <strong>{$resetLink}</strong></p>
               <p>Use the link above to reset your password. This link will expire in 30 minutes.</p>
            </div>
...
HTML;
  ...
  $hashotp = password_hash($token, PASSWORD_BCRYPT);
  $sql1 = "INSERT INTO otp_codes (otp, track, expires_at, attempts, uid, state) VALUES ('$hashotp', 'password_reset', '$expiry_bd', 0, $uid, 'not-used|active')";
